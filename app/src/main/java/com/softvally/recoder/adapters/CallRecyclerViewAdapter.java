package com.softvally.recoder.adapters;
...
import com.softvally.recoder.activities.CallActivity;
...
public class CallRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
	...
	public void openIncomingCall (@NonNull Context context, @NonNull CallObject incomingCallObject) {
	...
	private void showItemMenuDialog (@NonNull Context context, @NonNull CallObject incomingCallObject, @NonNull String correspondent) {
